...
class SoalSelesai extends StatefulWidget {
  @override
  _SoalSelesaiState createState() => _SoalSelesaiState();
}

class _SoalSelesaiState extends State<SoalSelesai> {
    ...
    final result = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () => {Get.toNamed(RouteNames.MapLevelScreen)},
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            _controller.resetCurrentQuestion();
                            Get.toNamed(RouteNames.SoalUjianPage, arguments: {
                              'idujian': idujian,
                            });
                          },
